...
<body>
	<div id="wrapper">
		...
		<header>
			<a href="/"><img src="img/logo3.png" alt="Geek shop logo"></a>
      <form name="sign_in">
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="product">
						...
						<p class="product-desc">Кружка с принтом из сериала "Друзья"</p>
				...
				<div class="col-sm-4">
					<div class="product">
						<div class="product-img">
							<a href="#"><img src="img/serials_book1.jpg" alt=""></a>
						</div>
						<p class="product-title">
